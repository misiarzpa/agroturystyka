...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { description: @about.description, name: @about.name, surname: @about.surname }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { description: @about.description, name: @about.name, surname: @about.surname }
    assert_redirected_to about_path(assigns(:about))
  end
